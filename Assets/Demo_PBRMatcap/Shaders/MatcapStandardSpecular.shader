...
Shader "Matcap/Standard (Specular setup)"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "UnityMatcapStandardCoreForward.cginc"
        ...
        Pass
        {
            ...
            #include "UnityMatcapStandardCore.cginc"
	...
	FallBack "VertexLit"
    CustomEditor "StandardMatcapShaderGUI"
}
